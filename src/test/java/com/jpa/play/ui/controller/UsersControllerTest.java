...
public class UsersControllerTest {
    ...
    // This Places the Mocked Spring bean in the SLICED WEBMVC CONTEXT  sliced WebMVC is a lightweight Servlet context used in web tier tests on the Spring Framework.
    @MockBean
